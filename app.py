...
def page_main() -> None:
    ...
    # ---------- NEXT STEP TAB ----------
        ...
        # (use your current Next step implementation here — unchanged)
        # If you already pasted my previous Next-step redesign,
        # you can keep that block exactly as-is.
        pass  # placeholder if you haven't pasted it yet
